...
test("an emergency encounter shows its SBAR beside the warning without routine options", async () => {
  ...
  expect(screen.queryByRole("region", { name: "Access options" })).toBeNull();
});
