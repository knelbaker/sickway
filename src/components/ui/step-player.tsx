...
> & {
    ...
    seekable?: boolean
    /** Accessible names of the control, for translation. */
...
function StepPlayer({
    ...
    seekable = false,
    controlLabels = { play: 'Play', pause: 'Pause', replay: 'Replay' },
    className,
    ...props
}: StepPlayerProps) {
        ...
        >
            {showControl && (
                <motion.button
                    ...
                    aria-label={finished ? controlLabels.replay : isPlaying ? controlLabels.pause : controlLabels.play}
                    ...
                    className="flex shrink-0 cursor-pointer touch-manipulation select-none items-center justify-center rounded-full bg-ink text-paper outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
                >
            ...
            <div
                ...
                className="flex flex-1 items-center justify-center rounded-full bg-ink/8"
            >
                {items.map((step, i) => {
